export default {
  ...
  Close: '關閉',
  Formats: '格式',
  'Your browser doesn\'t support direct access to the clipboard. Please use the Ctrl+XCV keyboard shortcuts instead.': '您的瀏覽器不支援存取剪貼簿，可以使用快速鍵 Ctrl + XCV 代替剪下、複製與貼上。',
  Headers: '標題',
  'Header 1': '標題 1',
  'Header 2': '標題 2',
  'Header 3': '標題 3',
  ...
  'Source code': '原始碼',
  'InsertEdit code sample': '插入編輯 程式碼範例',
  Language: '語言',
  'Code sample...': '程式碼範例...',
  'Color Picker': '選色器',
  R: '紅',
  ...
  Apply: '應用',
  Back: '後退',
  'Insert datetime': '插入 日期時間',
  Datetime: '日期時間',
  'Insert/Edit Link': '插入編輯連結',
  'Insert/edit link': '插入編輯連結',
  ...
  'Link list': '連結清單',
  'Insert video': '插入影音',
  'Insert/edit video': '插件編輯 影音',
  'Insert/edit media': '插入編輯 媒體',
  ...
  'yenyuan character variant one': '日圓人民幣符號變化型',
  ...
  Black: '黑色',
  White: '白色',
  'Switch to or from fullscreen mode': '轉換自至全螢幕模式',
